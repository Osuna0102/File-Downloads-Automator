...
root.iconbitmap('D:\Descargas\Imagenes\lukasz-groszfeld-3.jpg')
root.geometry("500x170")

# Define Our Images

add_folder_image = ImageTk.PhotoImage(Image.open("D:\Descargas\Imagenes\lukasz-groszfeld-3.jpg").resize((20,20), Image.ANTIALIAS))
add_list_image = ImageTk.PhotoImage(Image.open("D:\Descargas\Imagenes\lukasz-groszfeld-3.jpg").resize((20,20), Image.ANTIALIAS))
